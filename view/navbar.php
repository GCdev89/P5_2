...
<nav class="navbar navbar-expand-lg sticky-top navbar-dark bg-dark pt-1 my-auto">
    ...
    <div class="collapse navbar-collapse my-auto" id="navbarMain">
        <ul class="navbar-nav mr-auto ml-3 my-auto">
            ...
            <li class="nav-item pr-3 <?php if(isset($isActive) && $isActive == 'dad'){echo'h3 active';} ?>"><a class="nav-link" href="index.php?action=home&amp;parent=dad">Le coin des papas</a></li>
            <li class="nav-item pr-3 <?php if(isset($isActive) && $isActive == 'mom'){echo'h3 active';} ?>"><a class="nav-link" href="index.php?action=home&amp;parent=mom">Le coin des mamans</a></li>
